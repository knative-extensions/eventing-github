...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.GitHubSource, desired *v1alpha1.GitHubSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GitHubSource, desiredFinalizers sets.Set[string]) (*v1alpha1.GitHubSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.GitHubSource, desiredFinalizers sets.Set[string]) (*v1alpha1.GitHubSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.GitHubSource, desiredFinalizers sets.Set[string]) (*v1alpha1.GitHubSource, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.GitHubSource, reconcileEvent reconciler.Event) (*v1alpha1.GitHubSource, error) {
	...
	if err != nil {
		...
		getter := r.Client.SourcesV1alpha1().GitHubSources(resource.Namespace)
