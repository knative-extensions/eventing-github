...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GitHubSource, desiredFinalizers sets.String) (*v1alpha1.GitHubSource, error) {
	// Don't modify the informers copy.
