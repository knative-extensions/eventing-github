...
import (
	...
	versionedscheme "knative.dev/eventing-github/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-github/pkg/client/injection/client"
	githubsource "knative.dev/eventing-github/pkg/client/injection/informers/sources/v1alpha1/githubsource"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.GitHubSource"),
	)
